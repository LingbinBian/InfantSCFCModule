...
function network_average(N_roi,scan,type,gender)
    ...
    switch gender
        case 0
            results_dir='results_DTI_strength';
        case 1
            results_dir='results_DTI_strength_F';
        otherwise
            results_dir='results_DTI_strength_M';
    end
    data_path = fileparts(mfilename('fullpath'));
    
    group_results_path=fullfile(data_path,['../',results_dir,'/','roi_',num2str(N_roi),'_1_',scan_dir,'/SC_ave_results_',scan_dir]);
