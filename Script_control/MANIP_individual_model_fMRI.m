...
for scan=1:2
    for H=1:2
        for resolution=1.01:0.01:1.4  % modularity parameters      
            ...
            individual(scan,positive,N_roi,resolution,H,gender);
        end
    end
end
end
...
% -------------------------------------------------------------------------
% nested function
function individual(scan,positive,N_roi,resolution,H,gender)
    N_window=9;
    switch gender
        case 0
            if scan==1
    ...
    for i=1:N_subj
        ...
        switch gender
            ...
            case 1
                if positive==1
                    load(['/Users/lingbinbian/Documents/BCP_fMRI_sMRI/data_fMRI_F/',num2str(N_roi),'FC_1_',scan_dir,'/',subj_info{i,4},'BCP',subj_info{i,1},'_',month,'mo_',scan_dir,'.mat'])
                    if H==1
                        FC=FC(1:N_roi/2,1:N_roi/2);
                    else
                        FC=FC(N_roi/2+1:end,N_roi/2+1:end);
                    ...
                    load(['/Users/lingbinbian/Documents/BCP_fMRI_sMRI/data_fMRI_F/',num2str(N_roi),'FC_',scan_dir,'/',subj_info{i,4},'BCP',subj_info{i,1},'_',month,'mo_',scan_dir,'.mat'])
                    if H==1
                        FC=FC(1:N_roi/2,1:N_roi/2);
                    else
                        FC=FC(N_roi/2+1:end,N_roi/2+1:end);
            ...
            otherwise
                if positive==1
                    load(['/Users/lingbinbian/Documents/BCP_fMRI_sMRI/data_fMRI_M/',num2str(N_roi),'FC_1_',scan_dir,'/',subj_info{i,4},'BCP',subj_info{i,1},'_',month,'mo_',scan_dir,'.mat'])
                    if H==1
                        FC=FC(1:N_roi/2,1:N_roi/2);
                    else
                        FC=FC(N_roi/2+1:end,N_roi/2+1:end);
                    ...
                    load(['/Users/lingbinbian/Documents/BCP_fMRI_sMRI/data_fMRI_M/',num2str(N_roi),'FC_',scan_dir,'/',subj_info{i,4},'BCP',subj_info{i,1},'_',month,'mo_',scan_dir,'.mat'])
                    if H==1
                        FC=FC(1:N_roi/2,1:N_roi/2);
                    else
                        FC=FC(N_roi/2+1:end,N_roi/2+1:end);
    ...
    switch gender
        ...
        case 1
            if positive==1
                if H==1
                    group_path=fullfile(data_path,['../results_fMRI_F/','roi_',num2str(N_roi),'_1_',scan_dir,'/','LH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                else
                    group_path=fullfile(data_path,['../results_fMRI_F/','roi_',num2str(N_roi),'_1_',scan_dir,'/','RH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
               
                end
                
            else
                if H==1
                    group_path=fullfile(data_path,['../results_fMRI_F/','roi_',num2str(N_roi),'_',scan_dir,'/','LH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                else
                    group_path=fullfile(data_path,['../results_fMRI_F/','roi_',num2str(N_roi),'_',scan_dir,'/','RH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
        ...
        otherwise
            if positive==1
                if H==1
                    group_path=fullfile(data_path,['../results_fMRI_M/','roi_',num2str(N_roi),'_1_',scan_dir,'/','LH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                else
                    group_path=fullfile(data_path,['../results_fMRI_M/','roi_',num2str(N_roi),'_1_',scan_dir,'/','RH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
               
                end
                
            else
                if H==1
                    group_path=fullfile(data_path,['../results_fMRI_M/','roi_',num2str(N_roi),'_',scan_dir,'/','LH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                else
                    group_path=fullfile(data_path,['../results_fMRI_M/','roi_',num2str(N_roi),'_',scan_dir,'/','RH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
