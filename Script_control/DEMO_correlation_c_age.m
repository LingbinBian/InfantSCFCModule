% MANIP correlation between structural-functional consistency and age
...
switch gender
    case 0
        load(['/Users/lingbinbian/Documents/BCP_fMRI_sMRI/results_SC_strength_FC/roi_',num2str(N_roi),'_1_',scan_dir,'/c_mean_SC_FC_results.mat']);
    case 1
        load(['/Users/lingbinbian/Documents/BCP_fMRI_sMRI/results_SC_strength_FC_F/roi_',num2str(N_roi),'_1_',scan_dir,'/c_mean_SC_FC_results.mat']);
    otherwise
        load(['/Users/lingbinbian/Documents/BCP_fMRI_sMRI/results_SC_strength_FC_M/roi_',num2str(N_roi),'_1_',scan_dir,'/c_mean_SC_FC_results.mat']);
end

% structural-functional consistency (LH)
switch N_roi
    case 100
        ...
        c_LH_Default     =mean(c_mean(38:50,:));
    case 200
...
ylabel('c','fontname','times');
switch gender
    case 0
        title(['SC-FC consistency (LH)',', ROI=',num2str(N_roi),', ',scan_dir],'fontname','times');
    case 1
        title(['SC-FC consistency (LH) Female',', ROI=',num2str(N_roi),', ',scan_dir],'fontname','times');
    otherwise
        title(['SC-FC consistency (LH) Male',', ROI=',num2str(N_roi),', ',scan_dir],'fontname','times');
end
...
switch gender
    case 0
        saveas(gcf,['../results_SC_strength_FC/roi_',num2str(N_roi),'_1_',scan_dir,'/LH/C_mean_SC_FC_7_network_',scan_dir,'_age.fig'])
        saveas(gcf,['../results_SC_strength_FC/roi_',num2str(N_roi),'_1_',scan_dir,'/LH/C_mean_SC_FC_7_network_',scan_dir,'_age.svg'])
    case 1
        saveas(gcf,['../results_SC_strength_FC_F/roi_',num2str(N_roi),'_1_',scan_dir,'/LH/C_mean_SC_FC_7_network_',scan_dir,'_age.fig'])
        saveas(gcf,['../results_SC_strength_FC_F/roi_',num2str(N_roi),'_1_',scan_dir,'/LH/C_mean_SC_FC_7_network_',scan_dir,'_age.svg'])
    otherwise
        saveas(gcf,['../results_SC_strength_FC_M/roi_',num2str(N_roi),'_1_',scan_dir,'/LH/C_mean_SC_FC_7_network_',scan_dir,'_age.fig'])
        saveas(gcf,['../results_SC_strength_FC_M/roi_',num2str(N_roi),'_1_',scan_dir,'/LH/C_mean_SC_FC_7_network_',scan_dir,'_age.svg'])
end


% -------------------------------------------------------------------------
% structural-functional consistency (RH)
switch N_roi
    case 100
...
switch gender
    case 0
        title(['SC-FC consistency (RH)',', ROI=',num2str(N_roi),', ',scan_dir],'fontname','times');
    case 1
        title(['SC-FC consistency (RH) Female',', ROI=',num2str(N_roi),', ',scan_dir],'fontname','times');
    otherwise
        title(['SC-FC consistency (RH) Male',', ROI=',num2str(N_roi),', ',scan_dir],'fontname','times');
end
legend(hLines, networkNames, 'Location', 'best', 'Box', 'off');
grid on;
set(gca, 'FontSize', 11,'fontname','times');
...
switch gender
    case 0
        saveas(gcf,['../results_SC_strength_FC/roi_',num2str(N_roi),'_1_',scan_dir,'/RH/C_mean_SC_FC_7_network_',scan_dir,'_age.fig'])
        saveas(gcf,['../results_SC_strength_FC/roi_',num2str(N_roi),'_1_',scan_dir,'/RH/C_mean_SC_FC_7_network_',scan_dir,'_age.svg'])
    case 1
        saveas(gcf,['../results_SC_strength_FC_F/roi_',num2str(N_roi),'_1_',scan_dir,'/RH/C_mean_SC_FC_7_network_',scan_dir,'_age.fig'])
        saveas(gcf,['../results_SC_strength_FC_F/roi_',num2str(N_roi),'_1_',scan_dir,'/RH/C_mean_SC_FC_7_network_',scan_dir,'_age.svg'])
    otherwise
        saveas(gcf,['../results_SC_strength_FC_M/roi_',num2str(N_roi),'_1_',scan_dir,'/RH/C_mean_SC_FC_7_network_',scan_dir,'_age.fig'])
        saveas(gcf,['../results_SC_strength_FC_M/roi_',num2str(N_roi),'_1_',scan_dir,'/RH/C_mean_SC_FC_7_network_',scan_dir,'_age.svg'])
end
