...
for scan=1:2
    for H=1:2
        for resolution=1.01:0.01:1.4
            ...
            individual(scan,type,positive,N_roi,resolution,H,gender);
        end
    end
end
end
...
% -------------------------------------------------------------------------
% 
function individual(scan,type,positive,N_roi,resolution,H,gender)
    ...
    % subject 000195 lack the gender information
    switch gender
        case 0
            N_scan=391;
        case 1
    ...
    switch gender
        ...
        case 1
             if positive==1
                if type==1
                    if H==1
                        group_path=fullfile(data_path,['../results_DTI_strength_F/','roi_',num2str(N_roi),'_1_',scan_dir,'/','LH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                    else
                        group_path=fullfile(data_path,['../results_DTI_strength_F/','roi_',num2str(N_roi),'_1_',scan_dir,'/','RH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                   
                    end
                else
                    if H==1
                        group_path=fullfile(data_path,['../results_DTI_count_F/','roi_',num2str(N_roi),'_1_',scan_dir,'/','LH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                    else
                        group_path=fullfile(data_path,['../results_DTI_count_F/','roi_',num2str(N_roi),'_1_',scan_dir,'/','RH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                ...
                if type==1
                    if H==1
                        group_path=fullfile(data_path,['../results_DTI_strength_F/','roi_',num2str(N_roi),'_',scan_dir,'/','LH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                    else
                        group_path=fullfile(data_path,['../results_DTI_strength_F/','roi_',num2str(N_roi),'_',scan_dir,'/','RH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                 
                    end
                else
                    if H==1
                        group_path=fullfile(data_path,['../results_DTI_count_F/','roi_',num2str(N_roi),'_',scan_dir,'/','LH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                    else
                        group_path=fullfile(data_path,['../results_DTI_count_F/','roi_',num2str(N_roi),'_',scan_dir,'/','RH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
        ...
        otherwise
             if positive==1
                if type==1
                    if H==1
                        group_path=fullfile(data_path,['../results_DTI_strength_M/','roi_',num2str(N_roi),'_1_',scan_dir,'/','LH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                    else
                        group_path=fullfile(data_path,['../results_DTI_strength_M/','roi_',num2str(N_roi),'_1_',scan_dir,'/','RH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                   
                    end
                else
                    if H==1
                        group_path=fullfile(data_path,['../results_DTI_count_M/','roi_',num2str(N_roi),'_1_',scan_dir,'/','LH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                    else
                        group_path=fullfile(data_path,['../results_DTI_count_M/','roi_',num2str(N_roi),'_1_',scan_dir,'/','RH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                ...
                if type==1
                    if H==1
                        group_path=fullfile(data_path,['../results_DTI_strength_M/','roi_',num2str(N_roi),'_',scan_dir,'/','LH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                    else
                        group_path=fullfile(data_path,['../results_DTI_strength_M/','roi_',num2str(N_roi),'_',scan_dir,'/','RH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                 
                    end
                else
                    if H==1
                        group_path=fullfile(data_path,['../results_DTI_count_M/','roi_',num2str(N_roi),'_',scan_dir,'/','LH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
                    else
                        group_path=fullfile(data_path,['../results_DTI_count_M/','roi_',num2str(N_roi),'_',scan_dir,'/','RH/',num2str(resolution),'/grouplevel_data_',scan_dir]);
    ...
    save(group_path,'label','subj_info','age_group','count_subj');
